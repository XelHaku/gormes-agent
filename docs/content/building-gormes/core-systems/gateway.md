...
- **Priority connector wave** (Phase 2.B.4, 2.B.10) — WhatsApp ingress normalization plus WeCom/WeiXin shared-bot seams now freeze ingress/reply behavior ahead of full transports
