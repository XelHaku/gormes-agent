...
## Autoloop execution contract

`cmd/autoloop` is the executor for this roadmap, not a separate backlog. Its
...
instructions elsewhere. `autoloop` should consume the same source of truth that
