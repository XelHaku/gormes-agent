...
- [Context Compression and Caching](../context-compression-and-caching) — how the built-in compressor works
- [Memory Provider Plugins](../memory-provider-plugin) — analogous single-select plugin system for memory
