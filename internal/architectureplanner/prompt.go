...
8. Do not implement runtime feature code; planning/docs/progress/web content work only.
9. Do not mark implementation complete without concrete repository evidence.
